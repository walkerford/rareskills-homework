...
import "@openzeppelin-v4/contracts/token/ERC777/ERC777.sol";
...
contract ReadOnlyPool is ReentrancyGuard, ERC20("LPToken", "LPT") {
    ...
    function removeLiquidity() external nonReentrant {
        ...
        uint256 ethToReturn = (originalStake[msg.sender] *
            (numLPTokens + totalLPTokens)) / totalLPTokens;
...
contract ReadOnlyAttacker {
    ...
    constructor(ReadOnlyPool pool_, VulnerableDeFiContract victim_) payable {
        victim = VulnerableDeFiContract(victim_);
